...
alias="diberry" # alias of the user such as jsmith
domain="microsoft.com" # domain of the user such as microsoft.com
user=$alias@$domain
subscriptionid="bb881e62-cf77-4d5d-89fb-29d71e930b66" # subscription id of the user
...
functionappsku="B1"
funcionappplanname=fnplan$randomIdentifier
echo "Create Azure Function plan $funcionappplanname"

az functionapp plan create \
    --resource-group $resourcegroupname \
    --name $funcionappplanname \
    --sku $functionappsku \
    --is-linux true \
    --location $region

# Create Azure Function app with system assigned identity to entire resource group
functionappname=fn$randomIdentifier
echo "Create Azure Function app $functionappname"

az functionapp create \
    --plan $funcionappplanname \
    --runtime python \
    --resource-group $resourcegroupname \
...
# Upload Azure Function code to Azure Function
# echo "Upload Azure Function code to Azure Function"

# echo "Create zip file in root named msdocs-etl.zip"
# cd .. && tar -a -cf msdocs-etl.zip *.*
