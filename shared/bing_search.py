...
def get_news(bing_key, bing_endpoint="https://api.bing.microsoft.com/v7.0/", search_term="Quantum computing", count=10, market="en-us"):

    client = NewsSearchClient(
        endpoint=bing_endpoint,
        credential=AzureKeyCredential(bing_key)
    )
